      ...
      <div className=" p-6 mx-auto md:ml-[120px] md:mr-[120px] ">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-[#001A45] mb-6">
            ...
            {/* </div> */}
            {/* ))} */}
            <button className="bg-[#FFFFFF] text-[#001A45] py-2 px-4 rounded-[2rem] w-80 h-11 border-[#001A45] border">
              read more
            </button>
          </div>
          <div className="lg:col-span-1">
            <h4 className="text-xl font-bold text-[#001A45] mb-6">
              New comment
            </h4>
