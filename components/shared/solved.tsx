...
export const Solved: React.FC<SolvedProps> = ({ data }) => {
  ...
  return (
    <div className="bg-gray-100 rounded-[16px] p-4 min-w-[280px] max-w-[280px] min-h-[320px] max-h-[320px] relative text-left mt-[24px]">
      ...
      <div
        ...
        style={{ height: "200px" }}
      >
        <div className="bg-[#EAFFEA] rounded-xl p-2">
          {/* <img src={smile} alt="Resolution" /> {data.resolution_comment} */}
        </div>
        {/* {data.description} */}
