...
export const FAQSection = () => (
  <section className="bg-white py-[20px] lg:py[80px]">
    <div className="text-left lg:text-center mb-7.5">
      <div>
        <b className="text-[24px] sm:text-[32px] text-[#001A45] font-unbounded px-[24px] lg:mx-[120px]">
          FAQ
        </b>
      </div>
      <div className="text-[18px] sm:text-[24px] text-[#001A45] mt-2.5 text-left lg:text-center px-[24px] lg:mx-[120px]">
        Your Guide to Getting Heard
      </div>
    </div>
    <div className="ml-2 mr-2 mx-[24px] lg:mx-[120px] bg-white p-5">
      ...
      <div className="bg-[#f4f4f4] p-5 mb-5 rounded-lg">
        ...
        <div className="text-xl text-[#001A45] mt-2.5">
          We lodge your complaint officially with the Indian Consumer Helpline
          and the company itself, doubling down on getting you a resolution.
        </div>
      </div>
      <div className="bg-[#f4f4f4] p-5 mb-5 rounded-lg">
      ...
      <div className="bg-[#f4f4f4] p-5 mb-5 rounded-lg">
        ...
        <div className="text-xl text-[#001A45] mt-2.5">
          The world, plus we go the extra mile by notifying the Indian Consumer
          Helpline and the concerned company.
        </div>
      </div>
    </div>
  </section>
