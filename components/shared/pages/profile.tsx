...
//         <a href="/profile" className="text-[#001A45] hover:underline">
//           Profile
//         </a>
//         <img src={navigationArrow} />
...
//             alt="Profile"
//             className="rounded-full lg:w-24 lg:h-24 w-14 h-14  object-cover"
//           />
//           <input
//             type="file"
//             id="photo-upload"
//             onChange={handlePhotoChange}
//             className="ml-2 text-sm text-[#001A45] p-2 border border-[#001A45] rounded hidden"
//           />
//           <button
...
//               className="mt-1 block w-full px-3 py-2 border h-[44px] border-[#001A45] rounded-[12px] border-opacity-50 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 placeholder-opacity-30 hover:border-[#0450CF] hover:text-opacity-70 active:border-opacity-70 active:text-opacity-70 active:bg-opacity-5"
//               placeholder="John"
//             />
//           </div>
//           <div className="w-full mr-2">
...
//             <label className="block font-bold text-[#001A45]">
//               Repeat Password
//             </label>
//             <input
//               type="password"
...
//           className="bg-[#B5F62B] hover:bg-[#A9E922] text-[#001A45] px-4 py-2 rounded font-bold w-full mt-4"
//         >
//           Save changes
//         </button>
//         <button
//           onClick={deleteUser}
//           className="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded font-bold w-full mt-4"
//         >
//           Delete Account
//         </button>
//       </div>
